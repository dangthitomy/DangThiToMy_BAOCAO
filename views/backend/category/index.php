            ...
            <div class="card-header ">
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <a href="index.php?option=category&cat=trash" class="btn btn-sm btn-danger">Thùng rác</a>
               ...
               <div class="row">
                  <div class="col-md-4">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="text" name="parent_id" id="parent_id" placeholder="Nhập danh mục cha" class="form-control" onkeydown="handle_slug(this.value);">
                     </div>
                     <div class="mb-3">
